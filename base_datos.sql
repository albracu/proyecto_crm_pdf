...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 07-07-2016 a las 17:54:13
...
--
-- Base de datos: `vtigercolombia_novcali`
--
...
--
-- Volcado de datos para la tabla `com_vtiger_workflows`
--
...
--
-- Volcado de datos para la tabla `com_vtiger_workflows_seq`
--
...
--
-- Volcado de datos para la tabla `com_vtiger_workflowtasks`
--
...
--
-- Volcado de datos para la tabla `com_vtiger_workflowtasks_entitymethod`
--
...
--
-- Volcado de datos para la tabla `com_vtiger_workflowtasks_entitymethod_seq`
--
...
--
-- Volcado de datos para la tabla `com_vtiger_workflowtasks_seq`
--
...
--
-- Volcado de datos para la tabla `com_vtiger_workflowtask_queue`
--

INSERT INTO `com_vtiger_workflowtask_queue` (`task_id`, `entity_id`, `do_after`, `task_contents`) VALUES
(6, '12x3', 0, '{"fromEmail":"yo@alfredobravocuero.co","fromName":"admin","toEmail":"yo@alfredobravocuero.co","ccEmail":"","bccEmail":"","subject":"Regarding Contact Assignment","content":"An Contact has been assigned to you on vtigerCRM<br>Details of Contact are :<br><br>Contact Id:<b>CON1<\\/b><br>LastName:<b>Castillo<\\/b><br>FirstName:<b>Leonardo<\\/b><br>Lead Source:<b><\\/b><br>Department:<b><\\/b><br>Description:<b><\\/b><br><br><br>And <b>CustomerPortal Login Details<\\/b> is sent to the EmailID :-<br><br>Thank You<br>Admin"}'),
(6, '12x3', 0, '{"fromEmail":"yo@alfredobravocuero.co","fromName":"admin","toEmail":"yo@alfredobravocuero.co","ccEmail":"","bccEmail":"","subject":"Regarding Contact Assignment","content":"An Contact has been assigned to you on vtigerCRM<br>Details of Contact are :<br><br>Contact Id:<b>CON1<\\/b><br>LastName:<b>Castillo<\\/b><br>FirstName:<b>Leonardo<\\/b><br>Lead Source:<b><\\/b><br>Department:<b><\\/b><br>Description:<b><\\/b><br><br><br>And <b>CustomerPortal Login Details<\\/b> is sent to the EmailID :-<br><br>Thank You<br>Admin"}'),
(6, '12x3', 0, '{"fromEmail":"yo@alfredobravocuero.co","fromName":"admin","toEmail":"yo@alfredobravocuero.co","ccEmail":"","bccEmail":"","subject":"Regarding Contact Assignment","content":"An Contact has been assigned to you on vtigerCRM<br>Details of Contact are :<br><br>Contact Id:<b>CON1<\\/b><br>LastName:<b>Castillo<\\/b><br>FirstName:<b>Leonardo<\\/b><br>Lead Source:<b><\\/b><br>Department:<b><\\/b><br>Description:<b><\\/b><br><br><br>And <b>CustomerPortal Login Details<\\/b> is sent to the EmailID :-ljcl79@gmail.com<br><br>Thank You<br>Admin"}');
...
--
-- Estructura de tabla para la tabla `com_vtiger_workflow_tasktypes`
--
...
--
-- Volcado de datos para la tabla `com_vtiger_workflow_tasktypes`
--
...
--
-- Estructura de tabla para la tabla `com_vtiger_workflow_tasktypes_seq`
--
...
--
-- Volcado de datos para la tabla `com_vtiger_workflow_tasktypes_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_account`
--
...
(2, 'ACC1', 'VTiger Venezuela', 0, '', '', '0.00000000', '', '', '', '', '', '', '', '', '', '', 0, '0', '0', '0');
...
--
-- Volcado de datos para la tabla `vtiger_accountbillads`
--
...
--
-- Volcado de datos para la tabla `vtiger_accountscf`
--
...
--
-- Volcado de datos para la tabla `vtiger_accountshipads`
--
...
--
-- Volcado de datos para la tabla `vtiger_accounttype`
--
...
--
-- Volcado de datos para la tabla `vtiger_accounttype_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_actionmapping`
--
...
--
-- Volcado de datos para la tabla `vtiger_activitytype`
--
...
--
-- Volcado de datos para la tabla `vtiger_activitytype_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_activity_view`
--
...
--
-- Volcado de datos para la tabla `vtiger_activity_view_seq`
--
...
--
-- Estructura de tabla para la tabla `vtiger_assets`
--
...
--
-- Estructura de tabla para la tabla `vtiger_assetscf`
--
...
--
-- Estructura de tabla para la tabla `vtiger_assetstatus`
--
...
--
-- Volcado de datos para la tabla `vtiger_assetstatus`
--
...
--
-- Estructura de tabla para la tabla `vtiger_assetstatus_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_assetstatus_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_asteriskextensions`
--
...
--
-- Estructura de tabla para la tabla `vtiger_asteriskincomingevents`
--
...
--
-- Volcado de datos para la tabla `vtiger_attachmentsfolder`
--
...
--
-- Volcado de datos para la tabla `vtiger_attachmentsfolder_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_blocks`
--
...
(92, 33, 'LBL_SERVICE_CONTRACT_INFORMATION', 1, 0, 0, 0, 0, 0, 1, 0),
(93, 33, 'LBL_CUSTOM_INFORMATION', 2, 0, 0, 0, 0, 0, 1, 0),
(94, 36, 'LBL_PBXMANAGER_INFORMATION', 1, 0, 0, 0, 0, 0, 1, 0),
...
(101, 44, 'LBL_PROJECT_MILESTONE_INFORMATION', 1, 0, 0, 0, 0, 0, 1, 0),
(102, 44, 'LBL_CUSTOM_INFORMATION', 2, 0, 0, 0, 0, 0, 1, 0),
(103, 44, 'LBL_DESCRIPTION_INFORMATION', 3, 0, 0, 0, 0, 0, 1, 0),
(104, 45, 'LBL_PROJECT_TASK_INFORMATION', 1, 0, 0, 0, 0, 0, 1, 0),
(105, 45, 'LBL_CUSTOM_INFORMATION', 2, 0, 0, 0, 0, 0, 1, 0),
(106, 45, 'LBL_DESCRIPTION_INFORMATION', 3, 0, 0, 0, 0, 0, 1, 0),
(107, 46, 'LBL_PROJECT_INFORMATION', 1, 0, 0, 0, 0, 0, 1, 0),
(108, 46, 'LBL_CUSTOM_INFORMATION', 2, 0, 0, 0, 0, 0, 1, 0),
(109, 46, 'LBL_DESCRIPTION_INFORMATION', 3, 0, 0, 0, 0, 0, 1, 0),
...
--
-- Volcado de datos para la tabla `vtiger_blocks_seq`
--
...
--
-- Estructura de tabla para la tabla `vtiger_calendarsharedtype`
--
...
--
-- Volcado de datos para la tabla `vtiger_calendarsharedtype`
--
...
--
-- Estructura de tabla para la tabla `vtiger_calendarsharedtype_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_calendarsharedtype_seq`
--
...
--
-- Estructura de tabla para la tabla `vtiger_calendar_default_activitytypes`
--
...
--
-- Volcado de datos para la tabla `vtiger_calendar_default_activitytypes`
--
...
--
-- Estructura de tabla para la tabla `vtiger_calendar_default_activitytypes_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_calendar_default_activitytypes_seq`
--
...
--
-- Estructura de tabla para la tabla `vtiger_calendar_user_activitytypes`
--
...
--
-- Volcado de datos para la tabla `vtiger_calendar_user_activitytypes`
--
...
--
-- Estructura de tabla para la tabla `vtiger_calendar_user_activitytypes_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_calendar_user_activitytypes_seq`
--
...
--
-- Estructura de tabla para la tabla `vtiger_callduration`
--
...
--
-- Volcado de datos para la tabla `vtiger_callduration`
--
...
--
-- Estructura de tabla para la tabla `vtiger_callduration_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_callduration_seq`
--
...
--
-- Estructura de tabla para la tabla `vtiger_campaignaccountrel`
--
...
--
-- Estructura de tabla para la tabla `vtiger_campaignrelstatus`
--
...
--
-- Volcado de datos para la tabla `vtiger_campaignrelstatus`
--
...
--
-- Estructura de tabla para la tabla `vtiger_campaignrelstatus_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_campaignrelstatus_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_campaignstatus`
--
...
--
-- Volcado de datos para la tabla `vtiger_campaignstatus_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_campaigntype`
--
...
--
-- Volcado de datos para la tabla `vtiger_campaigntype_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_carrier`
--
...
--
-- Volcado de datos para la tabla `vtiger_carrier_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_contactaddress`
--
...
(3, 'Mérida', 'Av. Andres Bello. Res. Andres Bello.', 'Venezuela', '', 'Mérida', '', '', '', '', '', '', '');
...
--
-- Volcado de datos para la tabla `vtiger_contactdetails`
--
...
(3, 'CON1', 2, '', 'Leonardo', 'Castillo', 'ljcl79@gmail.com', '', '', '', '', '', '0', NULL, NULL, NULL, NULL, '', '0', '0', '', '0', '0', '0');
...
CREATE TABLE IF NOT EXISTS `vtiger_contactscf` (
  `contactid` int(19) NOT NULL DEFAULT '0',
  `cf_757` varchar(32) DEFAULT '',
  PRIMARY KEY (`contactid`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Volcado de datos para la tabla `vtiger_contactscf`
--

INSERT INTO `vtiger_contactscf` (`contactid`, `cf_757`) VALUES
(3, '13804050');
...
--
-- Volcado de datos para la tabla `vtiger_contactsubdetails`
--
...
--
-- Volcado de datos para la tabla `vtiger_contract_priority`
--
...
--
-- Volcado de datos para la tabla `vtiger_contract_priority_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_contract_status_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_contract_type_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_convertleadmapping`
--
...
--
-- Volcado de datos para la tabla `vtiger_crmentity`
--
...
(2, 1, 1, 1, 'Accounts', '', '2016-06-28 21:45:51', '2016-06-28 21:45:51', NULL, NULL, 0, 1, 0, 'VTiger Venezuela'),
(3, 1, 1, 1, 'Contacts', '', '2016-06-28 21:46:02', '2016-07-07 15:42:59', NULL, NULL, 0, 1, 0, 'Leonardo Castillo'),
(4, 1, 1, 1, 'Products', '', '2016-06-29 18:28:21', '2016-06-29 18:28:21', NULL, NULL, 0, 1, 0, 'Test1'),
(5, 1, 1, 1, 'Products', '', '2016-06-29 18:28:58', '2016-06-29 18:28:58', NULL, NULL, 0, 1, 0, 'Test2'),
(6, 1, 1, 1, 'Products', '', '2016-06-29 18:42:35', '2016-06-29 18:47:47', NULL, NULL, 0, 1, 0, 'Productos con descripciones y comentarios'),
(7, 1, 1, 1, 'Quotes', '', '2016-06-29 18:47:44', '2016-06-29 19:24:09', NULL, NULL, 0, 1, 0, 'Test Presupuesto'),
(8, 1, 1, 1, 'Products', '', '2016-06-29 19:20:03', '2016-06-29 19:20:03', NULL, NULL, 0, 1, 0, 'Producto 4'),
(9, 1, 1, 1, 'ServiceContracts', NULL, '2016-07-07 13:27:11', '2016-07-07 14:06:49', NULL, NULL, 0, 1, 0, 'Contrato');
...
--
-- Volcado de datos para la tabla `vtiger_crmentityrel`
--
...
--
-- Volcado de datos para la tabla `vtiger_crmentity_seq`
--
...
--
-- Estructura de tabla para la tabla `vtiger_crmsetup`
--
...
--
-- Volcado de datos para la tabla `vtiger_crmsetup`
--
...
--
-- Estructura de tabla para la tabla `vtiger_cron_task`
--
...
--
-- Volcado de datos para la tabla `vtiger_cron_task`
--
...
--
-- Volcado de datos para la tabla `vtiger_currencies`
--
...
--
-- Volcado de datos para la tabla `vtiger_currencies_seq`
--
...
--
-- Estructura de tabla para la tabla `vtiger_currency_decimal_separator`
--
...
--
-- Volcado de datos para la tabla `vtiger_currency_decimal_separator`
--
...
--
-- Estructura de tabla para la tabla `vtiger_currency_decimal_separator_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_currency_decimal_separator_seq`
--
...
--
-- Estructura de tabla para la tabla `vtiger_currency_grouping_pattern`
--
...
--
-- Volcado de datos para la tabla `vtiger_currency_grouping_pattern`
--
...
--
-- Estructura de tabla para la tabla `vtiger_currency_grouping_pattern_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_currency_grouping_pattern_seq`
--
...
--
-- Estructura de tabla para la tabla `vtiger_currency_grouping_separator`
--
...
--
-- Volcado de datos para la tabla `vtiger_currency_grouping_separator`
--
...
--
-- Estructura de tabla para la tabla `vtiger_currency_grouping_separator_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_currency_grouping_separator_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_currency_info`
--
...
(1, 'Colombia, Pesos', 'COP', '$', '1.00000', 'Active', '-11', 0);
...
--
-- Volcado de datos para la tabla `vtiger_currency_info_seq`
--
...
--
-- Estructura de tabla para la tabla `vtiger_currency_symbol_placement`
--
...
--
-- Volcado de datos para la tabla `vtiger_currency_symbol_placement`
--
...
--
-- Estructura de tabla para la tabla `vtiger_currency_symbol_placement_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_currency_symbol_placement_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_customerportal_prefs`
--
...
--
-- Volcado de datos para la tabla `vtiger_customerportal_tabs`
--
...
--
-- Volcado de datos para la tabla `vtiger_customview`
--
...
--
-- Volcado de datos para la tabla `vtiger_customview_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_cvadvfilter`
--
...
--
-- Estructura de tabla para la tabla `vtiger_cvadvfilter_grouping`
--
...
--
-- Volcado de datos para la tabla `vtiger_cvadvfilter_grouping`
--
...
--
-- Volcado de datos para la tabla `vtiger_cvcolumnlist`
--
...
(40, 0, 'vtiger_pbxmanager:callstatus:callstatus:PBXManager_Call_Status:V'),
(40, 1, 'vtiger_pbxmanager:customernumber:customernumber:PBXManager_Customer_Number:V'),
(40, 2, 'vtiger_pbxmanager:customer:customer:PBXManager_Customer:V'),
(40, 3, 'vtiger_pbxmanager:user:user:PBXManager_User:V'),
(40, 4, 'vtiger_pbxmanager:recordingurl:recordingurl:PBXManager_Recording_URL:V'),
(40, 5, 'vtiger_pbxmanager:totalduration:totalduration:PBXManager_Total_Duration:I'),
(40, 6, 'vtiger_pbxmanager:starttime:starttime:PBXManager_Start_Time:DT'),
...
--
-- Volcado de datos para la tabla `vtiger_cvstdfilter`
--
...
--
-- Volcado de datos para la tabla `vtiger_datashare_relatedmodules`
--
...
--
-- Volcado de datos para la tabla `vtiger_datashare_relatedmodules_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_date_format`
--
...
--
-- Volcado de datos para la tabla `vtiger_date_format_seq`
--
...
--
-- Estructura de tabla para la tabla `vtiger_dayoftheweek`
--
...
--
-- Volcado de datos para la tabla `vtiger_dayoftheweek`
--
...
--
-- Estructura de tabla para la tabla `vtiger_dayoftheweek_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_dayoftheweek_seq`
--
...
--
-- Estructura de tabla para la tabla `vtiger_defaultactivitytype`
--
...
--
-- Volcado de datos para la tabla `vtiger_defaultactivitytype`
--
...
--
-- Estructura de tabla para la tabla `vtiger_defaultactivitytype_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_defaultactivitytype_seq`
--
...
--
-- Estructura de tabla para la tabla `vtiger_defaulteventstatus`
--
...
--
-- Volcado de datos para la tabla `vtiger_defaulteventstatus`
--
...
--
-- Estructura de tabla para la tabla `vtiger_defaulteventstatus_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_defaulteventstatus_seq`
--
...
--
-- Estructura de tabla para la tabla `vtiger_default_record_view`
--
...
--
-- Volcado de datos para la tabla `vtiger_default_record_view`
--
...
--
-- Estructura de tabla para la tabla `vtiger_default_record_view_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_default_record_view_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_def_org_field`
--
...
--
-- Volcado de datos para la tabla `vtiger_def_org_share`
--
...
--
-- Volcado de datos para la tabla `vtiger_def_org_share_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_duration_minutes`
--
...
--
-- Volcado de datos para la tabla `vtiger_duration_minutes_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_emailtemplates`
--
...
--
-- Volcado de datos para la tabla `vtiger_emailtemplates_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_entityname`
--
...
(33, 'ServiceContracts', 'vtiger_servicecontracts', 'subject', 'servicecontractsid', 'servicecontractsid'),
...
--
-- Volcado de datos para la tabla `vtiger_eventhandlers`
--
...
(9, 'vtiger.entity.aftersave', 'modules/WSAPP/WorkFlowHandlers/WSAPPAssignToTracker.php', 'WSAPPAssignToTracker', '', 1, '["VTEntityDelta"]'),
(10, 'vtiger.entity.aftersave.final', 'modules/ModTracker/ModTrackerHandler.php', 'ModTrackerHandler', '', 1, '[]'),
(11, 'vtiger.entity.beforedelete', 'modules/ModTracker/ModTrackerHandler.php', 'ModTrackerHandler', '', 1, '[]'),
(12, 'vtiger.entity.afterrestore', 'modules/ModTracker/ModTrackerHandler.php', 'ModTrackerHandler', '', 1, '[]'),
(13, 'vtiger.entity.aftersave', 'modules/PBXManager/PBXManagerHandler.php', 'PBXManagerHandler', '', 1, '["VTEntityDelta"]'),
(14, 'vtiger.entity.afterdelete', 'modules/PBXManager/PBXManagerHandler.php', 'PBXManagerHandler', '', 1, '[]'),
(15, 'vtiger.entity.afterrestore', 'modules/PBXManager/PBXManagerHandler.php', 'PBXManagerHandler', '', 1, '[]'),
(16, 'vtiger.batchevent.save', 'modules/PBXManager/PBXManagerHandler.php', 'PBXManagerBatchHandler', '', 1, '[]'),
(17, 'vtiger.batchevent.delete', 'modules/PBXManager/PBXManagerHandler.php', 'PBXManagerBatchHandler', '', 1, '[]'),
...
--
-- Volcado de datos para la tabla `vtiger_eventhandlers_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_eventhandler_module`
--
...
--
-- Volcado de datos para la tabla `vtiger_eventhandler_module_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_eventstatus`
--
...
--
-- Volcado de datos para la tabla `vtiger_eventstatus_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_expectedresponse`
--
...
--
-- Volcado de datos para la tabla `vtiger_expectedresponse_seq`
--
...
--
-- Estructura de tabla para la tabla `vtiger_extnstore_users`
--
...
--
-- Volcado de datos para la tabla `vtiger_faqcategories`
--
...
--
-- Volcado de datos para la tabla `vtiger_faqcategories_seq`
--
...
--
-- Estructura de tabla para la tabla `vtiger_faqcf`
--
...
--
-- Volcado de datos para la tabla `vtiger_faqstatus`
--
...
--
-- Volcado de datos para la tabla `vtiger_faqstatus_seq`
--
...
--
-- Estructura de tabla para la tabla `vtiger_feedback`
--
...
--
-- Volcado de datos para la tabla `vtiger_field`
--
...
(30, 524, 'servicename', 'vtiger_service', 1, '2', 'servicename', 'Service Name', 1, 0, '', 100, 1, 88, 1, 'V~M', 0, 1, 'BAS', 1, '', 1),
(30, 525, 'service_no', 'vtiger_service', 1, '4', 'service_no', 'Service No', 1, 0, '', 100, 2, 88, 1, 'V~O', 3, 0, 'BAS', 0, '', 1),
(30, 526, 'discontinued', 'vtiger_service', 1, '56', 'discontinued', 'Service Active', 1, 2, '', 100, 4, 88, 1, 'V~O', 2, 3, 'BAS', 1, '', 0),
(30, 527, 'sales_start_date', 'vtiger_service', 1, '5', 'sales_start_date', 'Sales Start Date', 1, 2, '', 100, 9, 88, 1, 'D~O', 1, NULL, 'BAS', 1, '', 0),
(30, 528, 'sales_end_date', 'vtiger_service', 1, '5', 'sales_end_date', 'Sales End Date', 1, 2, '', 100, 10, 88, 1, 'D~O~OTH~GE~sales_start_date~Sales Start Date', 1, NULL, 'BAS', 1, '', 0),
(30, 529, 'start_date', 'vtiger_service', 1, '5', 'start_date', 'Support Start Date', 1, 2, '', 100, 11, 88, 1, 'D~O', 1, NULL, 'BAS', 1, '', 0),
(30, 530, 'expiry_date', 'vtiger_service', 1, '5', 'expiry_date', 'Support Expiry Date', 1, 2, '', 100, 12, 88, 1, 'D~O~OTH~GE~start_date~Start Date', 1, NULL, 'BAS', 1, '', 0),
(30, 531, 'website', 'vtiger_service', 1, '17', 'website', 'Website', 1, 2, '', 100, 6, 88, 1, 'V~O', 1, NULL, 'BAS', 1, '', 0),
(30, 532, 'createdtime', 'vtiger_crmentity', 1, '70', 'createdtime', 'Created Time', 1, 0, '', 100, 13, 88, 2, 'DT~O', 3, 0, 'BAS', 0, '', 0),
(30, 533, 'modifiedtime', 'vtiger_crmentity', 1, '70', 'modifiedtime', 'Modified Time', 1, 0, '', 100, 14, 88, 2, 'DT~O', 3, 0, 'BAS', 0, '', 0),
(30, 534, 'modifiedby', 'vtiger_crmentity', 1, '52', 'modifiedby', 'Last Modified By', 1, 0, '', 100, 16, 88, 3, 'V~O', 3, 0, 'BAS', 0, '', 0),
(30, 535, 'service_usageunit', 'vtiger_service', 1, '15', 'service_usageunit', 'Usage Unit', 1, 2, '', 100, 3, 88, 1, 'V~O', 1, NULL, 'BAS', 1, '', 0),
(30, 536, 'qty_per_unit', 'vtiger_service', 1, '1', 'qty_per_unit', 'No of Units', 1, 2, '', 100, 5, 88, 1, 'N~O', 1, NULL, 'BAS', 1, '', 1),
(30, 537, 'smownerid', 'vtiger_crmentity', 1, '53', 'assigned_user_id', 'Owner', 1, 0, '', 100, 8, 88, 1, 'I~O', 1, NULL, 'BAS', 1, '', 0),
(30, 538, 'servicecategory', 'vtiger_service', 1, '15', 'servicecategory', 'Service Category', 1, 2, '', 100, 7, 88, 1, 'V~O', 1, NULL, 'BAS', 1, '', 0),
(30, 539, 'unit_price', 'vtiger_service', 1, '72', 'unit_price', 'Price', 1, 0, '', 100, 1, 89, 1, 'N~O', 2, 2, 'BAS', 0, '', 1),
(30, 540, 'taxclass', 'vtiger_service', 1, '83', 'taxclass', 'Tax Class', 1, 2, '', 100, 4, 89, 1, 'V~O', 1, NULL, 'BAS', 1, '', 0),
(30, 541, 'commissionrate', 'vtiger_service', 1, '9', 'commissionrate', 'Commission Rate', 1, 2, '', 100, 2, 89, 1, 'N~O', 1, NULL, 'BAS', 1, '', 1),
(30, 542, 'description', 'vtiger_crmentity', 1, '19', 'description', 'Description', 1, 2, '', 100, 1, 91, 1, 'V~O', 1, NULL, 'BAS', 1, '', 0),
(33, 543, 'smownerid', 'vtiger_crmentity', 1, '53', 'assigned_user_id', 'Assigned To', 1, 2, '', 100, 4, 92, 1, 'V~M', 2, 2, 'BAS', 1, '', 1),
(33, 544, 'createdtime', 'vtiger_crmentity', 1, '70', 'createdtime', 'Created Time', 1, 0, '', 100, 17, 92, 2, 'DT~O', 3, 0, 'BAS', 0, '', 0),
(33, 545, 'modifiedtime', 'vtiger_crmentity', 1, '70', 'modifiedtime', 'Modified Time', 1, 0, '', 100, 18, 92, 2, 'DT~O', 3, 0, 'BAS', 0, '', 0),
(33, 546, 'start_date', 'vtiger_servicecontracts', 1, '5', 'start_date', 'Start Date', 1, 2, '', 100, 7, 92, 1, 'D~O', 2, 4, 'BAS', 1, '', 0),
(33, 547, 'end_date', 'vtiger_servicecontracts', 1, '5', 'end_date', 'End Date', 1, 2, '', 100, 11, 92, 2, 'D~O', 3, 0, 'BAS', 0, '', 0),
(33, 548, 'sc_related_to', 'vtiger_servicecontracts', 1, '10', 'sc_related_to', 'Related to', 1, 2, '', 100, 3, 92, 1, 'V~O', 2, 6, 'BAS', 1, '', 0),
(33, 549, 'tracking_unit', 'vtiger_servicecontracts', 1, '15', 'tracking_unit', 'Tracking Unit', 1, 2, '', 100, 6, 92, 1, 'V~O', 2, 7, 'BAS', 1, '', 0),
(33, 550, 'total_units', 'vtiger_servicecontracts', 1, '7', 'total_units', 'Total Units', 1, 2, '', 100, 8, 92, 1, 'V~O', 2, 8, 'BAS', 1, '', 1),
(33, 551, 'used_units', 'vtiger_servicecontracts', 1, '7', 'used_units', 'Used Units', 1, 2, '', 100, 10, 92, 1, 'V~O', 2, 9, 'BAS', 1, '', 1),
(33, 552, 'subject', 'vtiger_servicecontracts', 1, '1', 'subject', 'Subject', 1, 0, '', 100, 1, 92, 1, 'V~M', 0, 1, 'BAS', 1, '', 1),
(33, 553, 'due_date', 'vtiger_servicecontracts', 1, '23', 'due_date', 'Due date', 1, 2, '', 100, 9, 92, 1, 'D~O', 2, 5, 'BAS', 1, '', 0),
(33, 554, 'planned_duration', 'vtiger_servicecontracts', 1, '1', 'planned_duration', 'Planned Duration', 1, 2, '', 100, 13, 92, 2, 'V~O', 3, 0, 'BAS', 0, '', 0),
(33, 555, 'actual_duration', 'vtiger_servicecontracts', 1, '1', 'actual_duration', 'Actual Duration', 1, 2, '', 100, 15, 92, 2, 'V~O', 3, 0, 'BAS', 0, '', 0),
(33, 556, 'contract_status', 'vtiger_servicecontracts', 1, '15', 'contract_status', 'Status', 1, 2, '', 100, 12, 92, 1, 'V~O', 1, NULL, 'BAS', 1, '', 0),
(33, 557, 'priority', 'vtiger_servicecontracts', 1, '15', 'contract_priority', 'Priority', 1, 2, '', 100, 14, 92, 1, 'V~O', 1, NULL, 'BAS', 1, '', 0),
(33, 558, 'contract_type', 'vtiger_servicecontracts', 1, '15', 'contract_type', 'Type', 1, 2, '', 100, 5, 92, 1, 'V~O', 1, NULL, 'BAS', 1, '', 0),
(33, 559, 'progress', 'vtiger_servicecontracts', 1, '9', 'progress', 'Progress', 1, 2, '', 100, 16, 92, 2, 'N~O~2~2', 3, 3, 'BAS', 0, '', 0),
(33, 560, 'contract_no', 'vtiger_servicecontracts', 1, '4', 'contract_no', 'Contract No', 1, 0, '', 100, 2, 92, 1, 'V~O', 3, 0, 'BAS', 0, '', 1),
(33, 561, 'modifiedby', 'vtiger_crmentity', 1, '52', 'modifiedby', 'Last Modified By', 1, 0, '', 100, 17, 92, 3, 'V~O', 3, 0, 'BAS', 0, '', 0),
(36, 562, 'direction', 'vtiger_pbxmanager', 1, '1', 'direction', 'Direction', 1, 2, '', 100, 1, 94, 1, 'V~O', 1, NULL, 'BAS', 1, '', 0),
(36, 563, 'callstatus', 'vtiger_pbxmanager', 1, '1', 'callstatus', 'Call Status', 1, 2, '', 100, 2, 94, 1, 'V~O', 1, NULL, 'BAS', 1, '', 1),
(36, 564, 'starttime', 'vtiger_pbxmanager', 1, '70', 'starttime', 'Start Time', 1, 2, '', 100, 7, 94, 1, 'DT~O', 1, NULL, 'BAS', 1, '', 1),
(36, 565, 'endtime', 'vtiger_pbxmanager', 1, '70', 'endtime', 'End Time', 1, 2, '', 100, 8, 94, 1, 'DT~O', 1, NULL, 'BAS', 1, '', 0),
(36, 566, 'totalduration', 'vtiger_pbxmanager', 1, '7', 'totalduration', 'Total Duration', 1, 2, '', 100, 10, 94, 1, 'I~O', 1, NULL, 'BAS', 1, '', 0),
(36, 567, 'billduration', 'vtiger_pbxmanager', 1, '7', 'billduration', 'Bill Duration', 1, 2, '', 100, 11, 94, 1, 'I~O', 1, NULL, 'BAS', 1, '', 0),
(36, 568, 'recordingurl', 'vtiger_pbxmanager', 1, '17', 'recordingurl', 'Recording URL', 1, 2, '', 100, 9, 94, 1, 'V~O', 1, NULL, 'BAS', 1, '', 1),
(36, 569, 'sourceuuid', 'vtiger_pbxmanager', 1, '1', 'sourceuuid', 'Source UUID', 1, 2, '', 100, 12, 94, 1, 'V~O', 1, NULL, 'BAS', 1, '', 0),
(36, 570, 'gateway', 'vtiger_pbxmanager', 1, '1', 'gateway', 'Gateway', 1, 2, '', 100, 13, 94, 1, 'V~O', 1, NULL, 'BAS', 1, '', 0),
(36, 571, 'customer', 'vtiger_pbxmanager', 1, '10', 'customer', 'Customer', 1, 2, '', 100, 3, 94, 1, 'V~O', 1, NULL, 'BAS', 1, '', 1),
(36, 572, 'user', 'vtiger_pbxmanager', 1, '52', 'user', 'User', 1, 2, '', 100, 4, 94, 1, 'V~O', 1, NULL, 'BAS', 1, '', 1),
(36, 573, 'customernumber', 'vtiger_pbxmanager', 1, '11', 'customernumber', 'Customer Number', 1, 2, '', 100, 5, 94, 1, 'V~M', 1, NULL, 'BAS', 1, '', 0),
(36, 574, 'customertype', 'vtiger_pbxmanager', 1, '1', 'customertype', 'Customer Type', 1, 2, '', 100, 6, 94, 1, 'V~O', 1, NULL, 'BAS', 1, '', 0),
(36, 575, 'smownerid', 'vtiger_crmentity', 1, '53', 'assigned_user_id', 'Assigned To', 1, 2, '', 100, 14, 94, 1, 'V~M', 1, NULL, 'BAS', 1, '', 0),
(36, 576, 'createdtime', 'vtiger_crmentity', 1, '70', 'CreatedTime', 'Created Time', 1, 2, '', 100, 15, 94, 2, 'DT~O', 1, NULL, 'BAS', 1, '', 0),
(36, 577, 'modifiedtime', 'vtiger_crmentity', 1, '70', 'ModifiedTime', 'Modified Time', 1, 2, '', 100, 16, 94, 2, 'DT~O', 1, NULL, 'BAS', 1, '', 0),
(29, 578, 'phone_crm_extension', 'vtiger_users', 1, '11', 'phone_crm_extension', 'CRM Phone Extension', 1, 2, '', 100, 18, 79, 1, 'V~O', 1, NULL, 'BAS', 1, '', 0),
...
(44, 602, 'projectmilestonename', 'vtiger_projectmilestone', 1, '2', 'projectmilestonename', 'Project Milestone Name', 1, 2, '', 100, 1, 101, 1, 'V~M', 0, 1, 'BAS', 1, '', 1),
(44, 603, 'projectmilestonedate', 'vtiger_projectmilestone', 1, '5', 'projectmilestonedate', 'Milestone Date', 1, 2, '', 100, 5, 101, 1, 'D~O', 0, 3, 'BAS', 1, '', 1),
(44, 604, 'projectid', 'vtiger_projectmilestone', 1, '10', 'projectid', 'Related to', 1, 0, '', 100, 4, 101, 1, 'V~M', 0, 4, 'BAS', 1, '', 0),
(44, 605, 'projectmilestonetype', 'vtiger_projectmilestone', 1, '15', 'projectmilestonetype', 'Type', 1, 2, '', 100, 7, 101, 1, 'V~O', 1, NULL, 'BAS', 1, '', 1),
(44, 606, 'smownerid', 'vtiger_crmentity', 1, '53', 'assigned_user_id', 'Assigned To', 1, 2, '', 100, 6, 101, 1, 'V~M', 0, 2, 'BAS', 1, '', 0),
(44, 607, 'projectmilestone_no', 'vtiger_projectmilestone', 2, '4', 'projectmilestone_no', 'Project Milestone No', 1, 0, '', 100, 2, 101, 1, 'V~O', 3, 4, 'BAS', 0, '', 0),
(44, 608, 'createdtime', 'vtiger_crmentity', 1, '70', 'createdtime', 'Created Time', 1, 2, '', 100, 1, 102, 2, 'T~O', 1, NULL, 'BAS', 1, '', 0),
(44, 609, 'modifiedtime', 'vtiger_crmentity', 1, '70', 'modifiedtime', 'Modified Time', 1, 2, '', 100, 2, 102, 2, 'T~O', 1, NULL, 'BAS', 1, '', 0),
(44, 610, 'modifiedby', 'vtiger_crmentity', 1, '52', 'modifiedby', 'Last Modified By', 1, 0, '', 100, 3, 102, 3, 'V~O', 3, 0, 'BAS', 0, '', 0),
(44, 611, 'description', 'vtiger_crmentity', 1, '19', 'description', 'description', 1, 2, '', 100, 1, 103, 1, 'V~O', 1, NULL, 'BAS', 1, '', 0),
(45, 612, 'projecttaskname', 'vtiger_projecttask', 1, '2', 'projecttaskname', 'Project Task Name', 1, 2, '', 100, 1, 104, 1, 'V~M', 0, 1, 'BAS', 1, '', 1),
(45, 613, 'projecttasktype', 'vtiger_projecttask', 1, '15', 'projecttasktype', 'Type', 1, 2, '', 100, 4, 104, 1, 'V~O', 1, NULL, 'BAS', 1, '', 1),
(45, 614, 'projecttaskpriority', 'vtiger_projecttask', 1, '15', 'projecttaskpriority', 'Priority', 1, 2, '', 100, 3, 104, 1, 'V~O', 1, NULL, 'BAS', 1, '', 0),
(45, 615, 'projectid', 'vtiger_projecttask', 1, '10', 'projectid', 'Related to', 1, 0, '', 100, 6, 104, 1, 'V~M', 0, 5, 'BAS', 1, '', 0),
(45, 616, 'smownerid', 'vtiger_crmentity', 1, '53', 'assigned_user_id', 'Assigned To', 1, 2, '', 100, 7, 104, 1, 'V~M', 0, 2, 'BAS', 1, '', 1),
(45, 617, 'projecttasknumber', 'vtiger_projecttask', 1, '7', 'projecttasknumber', 'Project Task Number', 1, 2, '', 100, 5, 104, 1, 'I~O', 1, NULL, 'BAS', 1, '', 0),
(45, 618, 'projecttask_no', 'vtiger_projecttask', 2, '4', 'projecttask_no', 'Project Task No', 1, 0, '', 100, 2, 104, 1, 'V~O', 3, 4, 'BAS', 0, '', 0),
(45, 619, 'projecttaskprogress', 'vtiger_projecttask', 1, '15', 'projecttaskprogress', 'Progress', 1, 2, '', 100, 1, 105, 1, 'V~O', 1, NULL, 'BAS', 1, '', 1),
(45, 620, 'projecttaskhours', 'vtiger_projecttask', 1, '7', 'projecttaskhours', 'Worked Hours', 1, 2, '', 100, 2, 105, 1, 'V~O', 1, NULL, 'BAS', 1, '', 0),
(45, 621, 'startdate', 'vtiger_projecttask', 1, '5', 'startdate', 'Start Date', 1, 2, '', 100, 3, 105, 1, 'D~O', 0, 3, 'BAS', 1, '', 1),
(45, 622, 'enddate', 'vtiger_projecttask', 1, '5', 'enddate', 'End Date', 1, 2, '', 100, 4, 105, 1, 'D~O~OTH~GE~startdate~Start Date', 1, NULL, 'BAS', 1, '', 1),
(45, 623, 'createdtime', 'vtiger_crmentity', 1, '70', 'createdtime', 'Created Time', 1, 2, '', 100, 5, 105, 2, 'T~O', 1, NULL, 'BAS', 1, '', 0),
(45, 624, 'modifiedtime', 'vtiger_crmentity', 1, '70', 'modifiedtime', 'Modified Time', 1, 2, '', 100, 6, 105, 2, 'T~O', 1, NULL, 'BAS', 1, '', 0),
(45, 625, 'modifiedby', 'vtiger_crmentity', 1, '52', 'modifiedby', 'Last Modified By', 1, 0, '', 100, 7, 105, 3, 'V~O', 3, 0, 'BAS', 0, '', 0),
(45, 626, 'description', 'vtiger_crmentity', 1, '19', 'description', 'description', 1, 2, '', 100, 1, 106, 1, 'V~O', 1, NULL, 'BAS', 1, '', 0),
(46, 627, 'projectname', 'vtiger_project', 1, '2', 'projectname', 'Project Name', 1, 2, '', 100, 1, 107, 1, 'V~M', 0, 1, 'BAS', 1, '', 1),
(46, 628, 'startdate', 'vtiger_project', 1, '23', 'startdate', 'Start Date', 1, 2, '', 100, 3, 107, 1, 'D~O', 0, 3, 'BAS', 1, '', 1),
(46, 629, 'targetenddate', 'vtiger_project', 1, '23', 'targetenddate', 'Target End Date', 1, 2, '', 100, 5, 107, 1, 'D~O~OTH~GE~startdate~Start Date', 0, 4, 'BAS', 1, '', 1),
(46, 630, 'actualenddate', 'vtiger_project', 1, '23', 'actualenddate', 'Actual End Date', 1, 2, '', 100, 6, 107, 1, 'D~O~OTH~GE~startdate~Start Date', 1, NULL, 'BAS', 1, '', 0),
(46, 631, 'projectstatus', 'vtiger_project', 1, '15', 'projectstatus', 'Status', 1, 2, '', 100, 7, 107, 1, 'V~O', 1, NULL, 'BAS', 1, '', 1),
(46, 632, 'projecttype', 'vtiger_project', 1, '15', 'projecttype', 'Type', 1, 2, '', 100, 8, 107, 1, 'V~O', 1, NULL, 'BAS', 1, '', 1),
(46, 633, 'linktoaccountscontacts', 'vtiger_project', 1, '10', 'linktoaccountscontacts', 'Related to', 1, 2, '', 100, 9, 107, 1, 'V~O', 1, NULL, 'BAS', 1, '', 0),
(46, 634, 'smownerid', 'vtiger_crmentity', 1, '53', 'assigned_user_id', 'Assigned To', 1, 2, '', 100, 4, 107, 1, 'V~M', 0, 2, 'BAS', 1, '', 1),
(46, 635, 'project_no', 'vtiger_project', 2, '4', 'project_no', 'Project No', 1, 0, '', 100, 2, 107, 1, 'V~O', 3, 0, 'BAS', 0, '', 0),
(46, 636, 'targetbudget', 'vtiger_project', 1, '7', 'targetbudget', 'Target Budget', 1, 2, '', 100, 1, 108, 1, 'V~O', 1, NULL, 'BAS', 1, '', 0),
(46, 637, 'projecturl', 'vtiger_project', 1, '17', 'projecturl', 'Project Url', 1, 2, '', 100, 2, 108, 1, 'V~O', 1, NULL, 'BAS', 1, '', 0),
(46, 638, 'projectpriority', 'vtiger_project', 1, '15', 'projectpriority', 'Priority', 1, 2, '', 100, 3, 108, 1, 'V~O', 1, NULL, 'BAS', 1, '', 0),
(46, 639, 'progress', 'vtiger_project', 1, '15', 'progress', 'Progress', 1, 2, '', 100, 4, 108, 1, 'V~O', 1, NULL, 'BAS', 1, '', 0),
(46, 640, 'createdtime', 'vtiger_crmentity', 1, '70', 'createdtime', 'Created Time', 1, 2, '', 100, 5, 108, 2, 'T~O', 1, NULL, 'BAS', 1, '', 0),
(46, 641, 'modifiedtime', 'vtiger_crmentity', 1, '70', 'modifiedtime', 'Modified Time', 1, 2, '', 100, 6, 108, 2, 'T~O', 1, NULL, 'BAS', 1, '', 0),
(46, 642, 'modifiedby', 'vtiger_crmentity', 1, '52', 'modifiedby', 'Last Modified By', 1, 0, '', 100, 7, 108, 3, 'V~O', 3, 0, 'BAS', 0, '', 0),
(46, 643, 'description', 'vtiger_crmentity', 1, '19', 'description', 'description', 1, 2, '', 100, 1, 109, 1, 'V~O', 1, NULL, 'BAS', 1, '', 0),
(48, 644, 'commentcontent', 'vtiger_modcomments', 1, '19', 'commentcontent', 'Comment', 1, 0, '', 100, 4, 110, 1, 'V~M', 0, 4, 'BAS', 2, '', 1),
(48, 645, 'smownerid', 'vtiger_crmentity', 1, '53', 'assigned_user_id', 'Assigned To', 1, 0, '', 100, 1, 111, 1, 'V~M', 0, 1, 'BAS', 2, '', 1),
(48, 646, 'createdtime', 'vtiger_crmentity', 1, '70', 'createdtime', 'Created Time', 1, 0, '', 100, 5, 111, 2, 'DT~O', 0, 2, 'BAS', 0, '', 0),
(48, 647, 'modifiedtime', 'vtiger_crmentity', 1, '70', 'modifiedtime', 'Modified Time', 1, 0, '', 100, 6, 111, 2, 'DT~O', 0, 3, 'BAS', 0, '', 0),
(48, 648, 'related_to', 'vtiger_modcomments', 1, '10', 'related_to', 'Related To', 1, 2, '', 100, 2, 111, 1, 'V~M', 2, 5, 'BAS', 2, '', 0),
(48, 649, 'smcreatorid', 'vtiger_crmentity', 1, '52', 'creator', 'Creator', 1, 2, '', 100, 4, 111, 2, 'V~O', 1, NULL, 'BAS', 1, '', 0),
(48, 650, 'parent_comments', 'vtiger_modcomments', 1, '10', 'parent_comments', 'Related To Comments', 1, 2, '', 100, 7, 111, 1, 'V~O', 1, NULL, 'BAS', 1, '', 0),
...
(45, 690, 'projecttaskstatus', 'vtiger_projecttask', 1, '15', 'projecttaskstatus', 'Status', 1, 2, '', 100, 8, 104, 1, 'V~O', 0, 6, 'BAS', 1, '', 0),
(48, 691, 'customer', 'vtiger_modcomments', 1, '10', 'customer', 'Customer', 1, 2, '', 100, 5, 110, 3, 'V~O', 1, NULL, 'BAS', 1, '', 0),
...
(48, 710, 'userid', 'vtiger_modcomments', 1, '10', 'userid', 'UserId', 1, 2, '', 100, 6, 110, 3, 'V~O', 1, NULL, 'BAS', 1, '', 0),
(48, 711, 'reasontoedit', 'vtiger_modcomments', 1, '19', 'reasontoedit', 'ReasonToEdit', 1, 2, '', 100, 7, 110, 1, 'V~O', 1, NULL, 'BAS', 1, '', 0),
...
(33, 752, 'cf_751', 'vtiger_servicecontractscf', 2, '21', 'cf_751', 'Especificación', 1, 2, '', 100, 1, 93, 1, 'V~O', 1, NULL, 'BAS', 1, '', 0),
(33, 754, 'cf_753', 'vtiger_servicecontractscf', 2, '71', 'cf_753', 'Valor', 1, 2, '', 100, 2, 93, 1, 'N~O', 1, NULL, 'BAS', 1, '', 0),
(33, 756, 'cf_755', 'vtiger_servicecontractscf', 2, '21', 'cf_755', 'Forma de pago', 1, 2, '', 100, 3, 93, 1, 'V~O', 1, NULL, 'BAS', 1, '', 0),
(4, 758, 'cf_757', 'vtiger_contactscf', 2, '1', 'cf_757', 'CC', 1, 2, '', 100, 30, 4, 1, 'V~O~LE~32', 1, NULL, 'BAS', 1, '', 0);
...
--
-- Volcado de datos para la tabla `vtiger_fieldmodulerel`
--

INSERT INTO `vtiger_fieldmodulerel` (`fieldid`, `module`, `relmodule`, `status`, `sequence`) VALUES
(113, 'Potentials', 'Accounts', NULL, 0),
(548, 'ServiceContracts', 'Contacts', NULL, NULL),
(548, 'ServiceContracts', 'Accounts', NULL, NULL),
(571, 'PBXManager', 'Leads', NULL, NULL),
(571, 'PBXManager', 'Contacts', NULL, NULL),
(571, 'PBXManager', 'Accounts', NULL, NULL),
...
(615, 'ProjectTask', 'Project', NULL, NULL),
(633, 'Project', 'Accounts', NULL, NULL),
(633, 'Project', 'Contacts', NULL, NULL),
(648, 'ModComments', 'Leads', NULL, NULL),
(648, 'ModComments', 'Contacts', NULL, NULL),
(648, 'ModComments', 'Accounts', NULL, NULL),
(650, 'ModComments', 'ModComments', NULL, NULL),
(648, 'ModComments', 'Potentials', NULL, NULL),
(648, 'ModComments', 'Project', NULL, NULL),
(648, 'ModComments', 'ProjectTask', NULL, NULL),
...
(648, 'ModComments', 'HelpDesk', NULL, NULL),
(648, 'ModComments', 'Faq', NULL, NULL),
...
--
-- Volcado de datos para la tabla `vtiger_field_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_freetags_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_glacct`
--
...
--
-- Volcado de datos para la tabla `vtiger_glacct_seq`
--
...
--
-- Estructura de tabla para la tabla `vtiger_google_oauth2`
--
...
--
-- Estructura de tabla para la tabla `vtiger_google_sync_fieldmapping`
--
...
--
-- Estructura de tabla para la tabla `vtiger_google_sync_settings`
--
...
--
-- Volcado de datos para la tabla `vtiger_group2role`
--
...
--
-- Volcado de datos para la tabla `vtiger_group2rs`
--
...
--
-- Volcado de datos para la tabla `vtiger_groups`
--
...
--
-- Volcado de datos para la tabla `vtiger_homedefault`
--
...
--
-- Estructura de tabla para la tabla `vtiger_homereportchart`
--
...
--
-- Volcado de datos para la tabla `vtiger_homestuff`
--
...
--
-- Volcado de datos para la tabla `vtiger_homestuff_seq`
--
...
--
-- Estructura de tabla para la tabla `vtiger_hour_format`
--
...
--
-- Volcado de datos para la tabla `vtiger_hour_format`
--
...
--
-- Estructura de tabla para la tabla `vtiger_hour_format_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_hour_format_seq`
--
...
--
-- Estructura de tabla para la tabla `vtiger_import_locks`
--
...
--
-- Estructura de tabla para la tabla `vtiger_import_queue`
--
...
--
-- Volcado de datos para la tabla `vtiger_industry`
--
...
--
-- Volcado de datos para la tabla `vtiger_industry_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_inventorynotification`
--
...
--
-- Volcado de datos para la tabla `vtiger_inventorynotification_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_inventoryproductrel`
--
...
(7, 6, 1, '1.000', '5000.00000000', NULL, NULL, '', NULL, 0, 4, '4.500', '10.000', '12.500'),
(7, 4, 2, '1.000', '3000.00000000', NULL, NULL, '', NULL, 0, 5, '4.500', '10.000', '12.500'),
(7, 5, 3, '1.000', '5000.00000000', NULL, NULL, '', NULL, 0, 6, '4.500', '10.000', '12.500'),
(7, 8, 4, '1.000', '1500.00000000', NULL, NULL, '', NULL, 0, 7, '4.500', '10.000', '12.500');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `vtiger_inventoryproductrel_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_inventoryproductrel_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_inventoryshippingrel`
--

INSERT INTO `vtiger_inventoryshippingrel` (`id`, `shtax1`, `shtax2`, `shtax3`) VALUES
(7, '4.500', '10.000', '12.500');
...
--
-- Volcado de datos para la tabla `vtiger_inventorytaxinfo`
--
...
--
-- Volcado de datos para la tabla `vtiger_inventorytaxinfo_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_inventory_tandc`
--
...
--
-- Volcado de datos para la tabla `vtiger_inventory_tandc_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_invoicestatus`
--
...
--
-- Volcado de datos para la tabla `vtiger_invoicestatus_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_language`
--

INSERT INTO `vtiger_language` (`id`, `name`, `prefix`, `label`, `lastupdated`, `sequence`, `isdefault`, `active`) VALUES
(1, 'English', 'en_us', 'US English', '2016-06-22 15:56:13', NULL, 1, 1),
(2, 'Hungarian', 'hu_hu', 'HU Magyar', '2016-06-22 16:01:37', NULL, 0, 1),
(3, 'Brazilian', 'pt_br', 'PT Brasil', '2016-06-22 16:02:35', NULL, 0, 1),
(4, 'J?zyk Polski', 'pl_pl', 'J?zyk Polski', '2016-06-22 16:02:35', NULL, 0, 1),
(5, 'British English', 'en_gb', 'British English', '2016-06-22 16:01:38', NULL, 0, 1),
(6, 'Mexican Spanish', 'es_mx', 'ES Mexico', '2016-06-22 16:01:38', NULL, 0, 1),
(7, 'Italian', 'it_it', 'IT Italian', '2016-06-22 16:01:38', NULL, 0, 1),
(8, 'Swedish', 'sv_se', 'Swedish', '2016-06-22 16:04:05', NULL, 0, 1),
(9, 'Russian', 'ru_ru', 'Russian', '2016-06-22 16:01:39', NULL, 0, 1),
(10, 'Dutch', 'nl_nl', 'NL-Dutch', '2016-06-22 16:01:39', NULL, 0, 1),
(11, 'Turkce', 'tr_tr', 'Turkce Dil Paketi', '2016-06-22 16:01:44', NULL, 0, 1),
(12, 'Romana', 'ro_ro', 'Romana', '2016-06-22 16:02:35', NULL, 0, 1),
(13, 'Spanish', 'es_es', 'ES Spanish', '2016-06-22 16:01:45', NULL, 0, 1),
(14, 'Pack de langue français', 'fr_fr', 'Pack de langue français', '2016-06-22 16:02:35', NULL, 0, 1),
(15, 'Deutsch', 'de_de', 'DE Deutsch', '2016-06-22 16:02:22', NULL, 0, 1),
(16, 'Arabic', 'ar_ae', 'Arabic', '2016-06-22 16:04:05', NULL, 0, 1);
...
--
-- Volcado de datos para la tabla `vtiger_language_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_leadsource`
--
...
--
-- Volcado de datos para la tabla `vtiger_leadsource_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_leadstatus`
--
...
--
-- Volcado de datos para la tabla `vtiger_leadstatus_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_lead_view`
--
...
--
-- Volcado de datos para la tabla `vtiger_lead_view_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_links`
--
...
(6, 42, 'DETAILVIEWBASIC', 'LBL_CHECK_STATUS', 'javascript:SMSNotifier.checkstatus($RECORD$)', 'themes/images/reload.gif', 0, NULL, NULL, NULL),
(8, 42, 'HEADERSCRIPT', 'SMSNotifierCommonJS', 'modules/SMSNotifier/SMSNotifierCommon.js', '', 0, NULL, NULL, NULL),
(9, 7, 'LISTVIEWBASIC', 'Send SMS', 'SMSNotifierCommon.displaySelectWizard(this, ''$MODULE$'');', '', 0, NULL, NULL, NULL),
(10, 7, 'DETAILVIEWBASIC', 'Send SMS', 'javascript:SMSNotifierCommon.displaySelectWizard_DetailView(''$MODULE$'', ''$RECORD$'');', '', 0, NULL, NULL, NULL),
(11, 4, 'LISTVIEWBASIC', 'Send SMS', 'SMSNotifierCommon.displaySelectWizard(this, ''$MODULE$'');', '', 0, NULL, NULL, NULL),
(12, 4, 'DETAILVIEWBASIC', 'Send SMS', 'javascript:SMSNotifierCommon.displaySelectWizard_DetailView(''$MODULE$'', ''$RECORD$'');', '', 0, NULL, NULL, NULL),
(13, 6, 'LISTVIEWBASIC', 'Send SMS', 'SMSNotifierCommon.displaySelectWizard(this, ''$MODULE$'');', '', 0, NULL, NULL, NULL),
(14, 6, 'DETAILVIEWBASIC', 'Send SMS', 'javascript:SMSNotifierCommon.displaySelectWizard_DetailView(''$MODULE$'', ''$RECORD$'');', '', 0, NULL, NULL, NULL),
(15, 4, 'DETAILVIEWSIDEBARWIDGET', 'Google Map', 'module=Google&view=Map&mode=showMap&viewtype=detail', '', 0, NULL, NULL, NULL),
(16, 7, 'DETAILVIEWSIDEBARWIDGET', 'Google Map', 'module=Google&view=Map&mode=showMap&viewtype=detail', '', 0, NULL, NULL, NULL),
(17, 6, 'DETAILVIEWSIDEBARWIDGET', 'Google Map', 'module=Google&view=Map&mode=showMap&viewtype=detail', '', 0, NULL, NULL, NULL),
(18, 4, 'LISTVIEWSIDEBARWIDGET', 'Google Contacts', 'module=Google&view=List&sourcemodule=Contacts', '', 0, NULL, NULL, NULL),
(19, 9, 'LISTVIEWSIDEBARWIDGET', 'Google Calendar', 'module=Google&view=List&sourcemodule=Calendar', '', 0, NULL, NULL, NULL),
(23, 48, 'HEADERSCRIPT', 'ModCommentsCommonHeaderScript', 'modules/ModComments/ModCommentsCommon.js', '', 0, NULL, NULL, NULL),
(24, 7, 'DETAILVIEWWIDGET', 'DetailViewBlockCommentWidget', 'block://ModComments:modules/ModComments/ModComments.php', '', 0, NULL, NULL, NULL),
(25, 4, 'DETAILVIEWWIDGET', 'DetailViewBlockCommentWidget', 'block://ModComments:modules/ModComments/ModComments.php', '', 0, NULL, NULL, NULL),
(26, 6, 'DETAILVIEWWIDGET', 'DetailViewBlockCommentWidget', 'block://ModComments:modules/ModComments/ModComments.php', '', 0, NULL, NULL, NULL),
(27, 2, 'DETAILVIEWWIDGET', 'DetailViewBlockCommentWidget', 'block://ModComments:modules/ModComments/ModComments.php', '', 0, NULL, NULL, NULL),
...
--
-- Volcado de datos para la tabla `vtiger_links_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_loginhistory`
--

INSERT INTO `vtiger_loginhistory` (`login_id`, `user_name`, `user_ip`, `logout_time`, `login_time`, `status`) VALUES
(1, 'admin', '::1', '0000-00-00 00:00:00', '2016-06-22 20:04:35', 'Signed in'),
(2, 'admin', '::1', '0000-00-00 00:00:00', '2016-06-28 08:55:52', 'Signed in'),
(3, 'admin', '127.0.0.1', '0000-00-00 00:00:00', '2016-06-29 01:38:02', 'Signed in'),
(4, 'admin', '127.0.0.1', '0000-00-00 00:00:00', '2016-06-29 01:41:23', 'Signed in'),
(5, 'admin', '127.0.0.1', '0000-00-00 00:00:00', '2016-06-29 16:07:13', 'Signed in'),
(6, 'admin', '127.0.0.1', '0000-00-00 00:00:00', '2016-06-29 19:55:26', 'Signed in'),
(7, 'admin', '127.0.0.1', '0000-00-00 00:00:00', '2016-06-29 21:30:53', 'Signed in'),
(8, 'admin', '127.0.0.1', '0000-00-00 00:00:00', '2016-07-07 17:08:04', 'Signed in');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `vtiger_mailmanager_mailattachments`
--
...
--
-- Estructura de tabla para la tabla `vtiger_mailmanager_mailrecord`
--
...
--
-- Estructura de tabla para la tabla `vtiger_mailmanager_mailrel`
--
...
--
-- Volcado de datos para la tabla `vtiger_manufacturer`
--
...
--
-- Volcado de datos para la tabla `vtiger_manufacturer_seq`
--
...
--
-- Estructura de tabla para la tabla `vtiger_mobile_alerts`
--
...
--
-- Volcado de datos para la tabla `vtiger_mobile_alerts`
--
...
--
-- Estructura de tabla para la tabla `vtiger_modcomments`
--
...
--
-- Estructura de tabla para la tabla `vtiger_modcommentscf`
--
...
--
-- Volcado de datos para la tabla `vtiger_modentity_num`
--
...
(17, 'ServiceContracts', 'SERCON', '1', '2', '1'),
...
--
-- Volcado de datos para la tabla `vtiger_modentity_num_seq`
--
...
--
-- Estructura de tabla para la tabla `vtiger_modtracker_basic`
--
...
--
-- Volcado de datos para la tabla `vtiger_modtracker_basic`
--

INSERT INTO `vtiger_modtracker_basic` (`id`, `crmid`, `module`, `whodid`, `changedon`, `status`) VALUES
(1, 2, 'Accounts', 1, '2016-06-28 21:45:51', 2),
(2, 3, 'Contacts', 1, '2016-06-28 21:46:02', 2),
(3, 4, 'Products', 1, '2016-06-29 18:28:21', 2),
(4, 5, 'Products', 1, '2016-06-29 18:28:58', 2),
(5, 6, 'Products', 1, '2016-06-29 18:42:35', 2),
(6, 7, 'Quotes', 1, '2016-06-29 18:47:44', 2),
(7, 6, 'Products', 1, '2016-06-29 18:47:47', 4),
(8, 8, 'Products', 1, '2016-06-29 19:20:03', 2),
(9, 7, 'Quotes', 1, '2016-06-29 19:24:09', 0),
(10, 9, 'ServiceContracts', 1, '2016-07-07 13:27:11', 2),
(11, 3, 'Contacts', 1, '2016-07-07 15:32:23', 0),
(12, 3, 'Contacts', 1, '2016-07-07 15:42:59', 0);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `vtiger_modtracker_basic_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_modtracker_basic_seq`
--
...
--
-- Estructura de tabla para la tabla `vtiger_modtracker_detail`
--
...
--
-- Volcado de datos para la tabla `vtiger_modtracker_detail`
--

INSERT INTO `vtiger_modtracker_detail` (`id`, `fieldname`, `prevalue`, `postvalue`) VALUES
(1, 'accountname', NULL, 'VTiger Venezuela'),
(1, 'account_no', NULL, 'ACC1'),
(1, 'annual_revenue', NULL, '0.00000000'),
(1, 'assigned_user_id', NULL, '1'),
(1, 'createdtime', NULL, '2016-06-28 21:45:51'),
(1, 'modifiedby', NULL, '1'),
(1, 'record_id', NULL, '2'),
(1, 'record_module', NULL, 'Accounts'),
(2, 'firstname', NULL, 'Leonardo'),
(2, 'contact_no', NULL, 'CON1'),
(2, 'lastname', NULL, 'Castillo'),
(2, 'account_id', NULL, '2'),
(2, 'assigned_user_id', NULL, '1'),
(2, 'createdtime', NULL, '2016-06-28 21:46:02'),
(2, 'modifiedby', NULL, '1'),
(2, 'support_start_date', NULL, '2016-06-28'),
(2, 'support_end_date', NULL, '2017-06-28'),
(2, 'record_id', NULL, '3'),
(2, 'record_module', NULL, 'Contacts'),
(3, 'productname', NULL, 'Test1'),
(3, 'product_no', NULL, 'PRO1'),
(3, 'discontinued', NULL, '1'),
(3, 'createdtime', NULL, '2016-06-29 18:28:21'),
(3, 'modifiedby', NULL, '1'),
(3, 'unit_price', NULL, '3000.00000000'),
...
(4, 'productname', NULL, 'Test2'),
(4, 'product_no', NULL, 'PRO2'),
(4, 'discontinued', NULL, '1'),
(4, 'createdtime', NULL, '2016-06-29 18:28:58'),
(4, 'modifiedby', NULL, '1'),
(4, 'unit_price', NULL, '5000.00000000'),
...
(5, 'productname', NULL, 'Productos con descripciones y comentarios'),
(5, 'product_no', NULL, 'PRO3'),
(5, 'discontinued', NULL, '1'),
(5, 'createdtime', NULL, '2016-06-29 18:42:35'),
(5, 'modifiedby', NULL, '1'),
(5, 'unit_price', NULL, '5000.00000000'),
...
(6, 'quote_no', NULL, 'QUO1'),
(6, 'subject', NULL, 'Test Presupuesto'),
(6, 'quotestage', NULL, 'Created'),
(6, 'contact_id', NULL, '3'),
(6, 'hdnsubtotal', NULL, '13000.00000000'),
(6, 'txtadjustment', NULL, '0.00000000'),
(6, 'hdngrandtotal', NULL, '16510.00000000'),
(6, 'hdntaxtype', NULL, 'group'),
(6, 'hdns_h_amount', NULL, '0.00000000'),
(6, 'account_id', NULL, '2'),
(6, 'assigned_user_id', NULL, '1'),
(6, 'createdtime', NULL, '2016-06-29 18:47:44'),
(6, 'modifiedby', NULL, '1'),
...
(6, 'productid', NULL, '6'),
(6, 'quantity', NULL, '1.000'),
(6, 'listprice', NULL, '5000.00000000'),
(6, 'tax1', NULL, '4.500'),
(6, 'tax2', NULL, '10.000'),
(6, 'tax3', NULL, '12.500'),
(6, 'pre_tax_total', NULL, '13000.00000000'),
(6, 'hdns_h_percent', NULL, '27'),
(6, 'record_id', NULL, '7'),
(6, 'record_module', NULL, 'Quotes'),
(8, 'productname', NULL, 'Producto 4'),
(8, 'product_no', NULL, 'PRO4'),
(8, 'discontinued', NULL, '1'),
(8, 'createdtime', NULL, '2016-06-29 19:20:03'),
(8, 'modifiedby', NULL, '1'),
(8, 'unit_price', NULL, '1500.00000000'),
...
(9, 'hdnsubtotal', '13000.00000000', '14500.00000000'),
(9, 'hdngrandtotal', '16510.00000000', '18415.00000000'),
(9, 'pre_tax_total', '13000.00000000', '14500.00000000'),
(10, 'assigned_user_id', NULL, '1'),
(10, 'createdtime', NULL, '2016-07-07 13:27:11'),
(10, 'start_date', NULL, '2016-07-07'),
(10, 'end_date', NULL, '2016-07-07'),
(10, 'sc_related_to', NULL, '3'),
(10, 'total_units', NULL, '0.00'),
(10, 'used_units', NULL, '0.00'),
(10, 'subject', NULL, 'Contrato'),
(10, 'due_date', NULL, '2017-07-06'),
(10, 'planned_duration', NULL, '365'),
(10, 'actual_duration', NULL, '1'),
(10, 'contract_status', NULL, 'Complete'),
(10, 'contract_no', NULL, 'SERCON1'),
(10, 'modifiedby', NULL, '1'),
(10, 'cf_751', NULL, 'Estudio Juiridico sobre la viabilidad, preservaci&oacute;n riesgos y posibles variaciones de la garant&iacute;a real de hipoteca sobre el bien inmueble descrito con folio ya mencionado, efectos de la garantia y  su recomendaci&oacute;n tipo de garant&iacute;a, naturaleza jur&iacute;dica del contrato de  hipoteca, el contratista se debera pronunciar acerca de cada  uno de los terminos se&ntilde;alados en este numeral y su manifestaci&oacute;n tendr&aacute; que ser escrita, y si es preciso ampliar la informaci&oacute;n de  forma verbal. Paragrafo: este contrato se ejecutara en un plazo maximo de 48 horas contados a partir de la entrega de los documentos solicitados al cliente en la clausula 10 del presente contrato y el anticipo confirmado en la cuenta mensionada en le  recibo'),
(10, 'cf_753', NULL, '340000.00000000'),
(10, 'cf_755', NULL, '1) anticipo de del  50% de la totalidad de los honorarios para iniciar el estudio, confirmado en cuenta a traves de cualquier medio lectr&oacute;nico,2) el  restante a la entrega del estudio tecnico juridico objeto del presente contrato , o el solo desestimiento por cualquier causa del cliente  dara lugar al pago de los honorarios restantes'),
(10, 'record_id', NULL, '9'),
(10, 'record_module', NULL, 'ServiceContracts'),
(11, 'mailingstreet', '', 'Av. Andres Bello. Res. Andres Bello.'),
(11, 'mailingcity', '', 'M&eacute;rida'),
(11, 'mailingstate', '', 'M&eacute;rida'),
(11, 'mailingcountry', '', 'Venezuela'),
(11, 'cf_757', '', '13804050'),
(12, 'email', '', 'ljcl79@gmail.com');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `vtiger_modtracker_relations`
--
...
--
-- Volcado de datos para la tabla `vtiger_modtracker_relations`
--

INSERT INTO `vtiger_modtracker_relations` (`id`, `targetmodule`, `targetid`, `changedon`) VALUES
(7, 'Quotes', 7, '2016-06-29 18:47:47');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `vtiger_modtracker_tabs`
--
...
--
-- Volcado de datos para la tabla `vtiger_modtracker_tabs`
--
...
--
-- Estructura de tabla para la tabla `vtiger_module_dashboard_widgets`
--
...
--
-- Volcado de datos para la tabla `vtiger_notificationscheduler`
--
...
--
-- Volcado de datos para la tabla `vtiger_notificationscheduler_seq`
--
...
--
-- Estructura de tabla para la tabla `vtiger_no_of_currency_decimals`
--
...
--
-- Volcado de datos para la tabla `vtiger_no_of_currency_decimals`
--
...
--
-- Estructura de tabla para la tabla `vtiger_no_of_currency_decimals_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_no_of_currency_decimals_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_opportunity_type`
--
...
--
-- Volcado de datos para la tabla `vtiger_opportunity_type_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_organizationdetails`
--
...
(1, 'Novacali', 'Av. Simón Bolívar', 'Valle', 'Cali', 'Colombia', '7600100', '+572322621515', '', '', 'logo.gif', NULL, '1234-5678-9012');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `vtiger_organizationdetails_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_organizationdetails_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_org_share_action2tab`
--
...
--
-- Volcado de datos para la tabla `vtiger_org_share_action_mapping`
--
...
--
-- Estructura de tabla para la tabla `vtiger_othereventduration`
--
...
--
-- Volcado de datos para la tabla `vtiger_othereventduration`
--
...
--
-- Estructura de tabla para la tabla `vtiger_othereventduration_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_othereventduration_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_parenttab`
--
...
--
-- Volcado de datos para la tabla `vtiger_parenttabrel`
--
...
--
-- Volcado de datos para la tabla `vtiger_payment_duration`
--
...
--
-- Volcado de datos para la tabla `vtiger_payment_duration_seq`
--
...
--
-- Estructura de tabla para la tabla `vtiger_pbxmanagercf`
--
...
--
-- Estructura de tabla para la tabla `vtiger_pbxmanager_gateway`
--
...
--
-- Estructura de tabla para la tabla `vtiger_pbxmanager_phonelookup`
--
...
--
-- Volcado de datos para la tabla `vtiger_picklist`
--
...
--
-- Volcado de datos para la tabla `vtiger_picklistvalues_seq`
--
...
--
-- Estructura de tabla para la tabla `vtiger_picklist_dependency`
--
...
--
-- Volcado de datos para la tabla `vtiger_picklist_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_postatus`
--
...
--
-- Volcado de datos para la tabla `vtiger_postatus_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_productcategory`
--
...
--
-- Volcado de datos para la tabla `vtiger_productcategory_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_productcf`
--
...
--
-- Volcado de datos para la tabla `vtiger_productcurrencyrel`
--

INSERT INTO `vtiger_productcurrencyrel` (`productid`, `currencyid`, `converted_price`, `actual_price`) VALUES
(4, 1, '3000.00000000', '3000.00000000'),
(5, 1, '5000.00000000', '5000.00000000'),
(6, 1, '5000.00000000', '5000.00000000'),
(8, 1, '1500.00000000', '1500.00000000');
...
--
-- Volcado de datos para la tabla `vtiger_products`
--
...
(4, 'PRO1', 'Test1', '', '', '', '0.00', '3000.00000000', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0.000', NULL, 1, '', 0, '', '', '', '', '', '0.000', '', 0, '', 0, '', 1),
(5, 'PRO2', 'Test2', '', '', '', '0.00', '5000.00000000', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0.000', NULL, 1, '', 0, '', '', '', '', '', '0.000', '', 0, '', 0, '', 1),
(6, 'PRO3', 'Productos con descripciones y comentarios', '', '', '', '0.00', '5000.00000000', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0.000', NULL, 1, '', 0, '', '', '', '', '', '0.000', '', 0, '', 0, '', 1),
(8, 'PRO4', 'Producto 4', '', '', '', '0.00', '1500.00000000', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0.000', NULL, 1, '', 0, '', '', '', '', '', '0.000', '', 0, '', 0, '', 1);
...
--
-- Volcado de datos para la tabla `vtiger_profile`
--
...
--
-- Volcado de datos para la tabla `vtiger_profile2field`
--
...
--
-- Volcado de datos para la tabla `vtiger_profile2globalpermissions`
--
...
--
-- Volcado de datos para la tabla `vtiger_profile2standardpermissions`
--
...
--
-- Volcado de datos para la tabla `vtiger_profile2tab`
--
...
--
-- Volcado de datos para la tabla `vtiger_profile2utility`
--
...
--
-- Volcado de datos para la tabla `vtiger_profile_seq`
--
...
--
-- Estructura de tabla para la tabla `vtiger_progress`
--
...
--
-- Volcado de datos para la tabla `vtiger_progress`
--
...
--
-- Estructura de tabla para la tabla `vtiger_progress_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_progress_seq`
--
...
--
-- Estructura de tabla para la tabla `vtiger_project`
--
...
--
-- Estructura de tabla para la tabla `vtiger_projectcf`
--
...
--
-- Estructura de tabla para la tabla `vtiger_projectmilestone`
--
...
--
-- Estructura de tabla para la tabla `vtiger_projectmilestonecf`
--
...
--
-- Estructura de tabla para la tabla `vtiger_projectmilestonetype`
--
...
--
-- Volcado de datos para la tabla `vtiger_projectmilestonetype`
--
...
--
-- Estructura de tabla para la tabla `vtiger_projectmilestonetype_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_projectmilestonetype_seq`
--
...
--
-- Estructura de tabla para la tabla `vtiger_projectpriority`
--
...
--
-- Volcado de datos para la tabla `vtiger_projectpriority`
--
...
--
-- Estructura de tabla para la tabla `vtiger_projectpriority_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_projectpriority_seq`
--
...
--
-- Estructura de tabla para la tabla `vtiger_projectstatus`
--
...
--
-- Volcado de datos para la tabla `vtiger_projectstatus`
--
...
--
-- Estructura de tabla para la tabla `vtiger_projectstatus_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_projectstatus_seq`
--
...
--
-- Estructura de tabla para la tabla `vtiger_projecttask`
--
...
--
-- Estructura de tabla para la tabla `vtiger_projecttaskcf`
--
...
--
-- Estructura de tabla para la tabla `vtiger_projecttaskpriority`
--
...
--
-- Volcado de datos para la tabla `vtiger_projecttaskpriority`
--
...
--
-- Estructura de tabla para la tabla `vtiger_projecttaskpriority_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_projecttaskpriority_seq`
--
...
--
-- Estructura de tabla para la tabla `vtiger_projecttaskprogress`
--
...
--
-- Volcado de datos para la tabla `vtiger_projecttaskprogress`
--
...
--
-- Estructura de tabla para la tabla `vtiger_projecttaskprogress_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_projecttaskprogress_seq`
--
...
--
-- Estructura de tabla para la tabla `vtiger_projecttaskstatus`
--
...
--
-- Volcado de datos para la tabla `vtiger_projecttaskstatus`
--
...
--
-- Estructura de tabla para la tabla `vtiger_projecttaskstatus_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_projecttaskstatus_seq`
--
...
--
-- Estructura de tabla para la tabla `vtiger_projecttasktype`
--
...
--
-- Volcado de datos para la tabla `vtiger_projecttasktype`
--
...
--
-- Estructura de tabla para la tabla `vtiger_projecttasktype_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_projecttasktype_seq`
--
...
--
-- Estructura de tabla para la tabla `vtiger_projecttype`
--
...
--
-- Volcado de datos para la tabla `vtiger_projecttype`
--
...
--
-- Estructura de tabla para la tabla `vtiger_projecttype_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_projecttype_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_quotes`
--
...
(7, 'Test Presupuesto', NULL, 'Created', NULL, 3, 'QUO1', '14500.00000000', '', '', 0, NULL, '0.00000000', '18415.00000000', 'group', NULL, NULL, '0.00000000', 2, '- Unless otherwise agreed in writing by the supplier all invoices are payable within thirty (30) days of the date of invoice, in the currency of the invoice, drawn on a bank based in India or by such other method as is agreed in advance by the Supplier.\r\n\r\n - All prices are not inclusive of VAT which shall be payable in addition by the Customer at the applicable rate.', 1, '1.000', '14500.00000000', 27);
...
--
-- Volcado de datos para la tabla `vtiger_quotesbillads`
--
...
--
-- Volcado de datos para la tabla `vtiger_quotescf`
--
...
--
-- Volcado de datos para la tabla `vtiger_quotesshipads`
--
...
--
-- Volcado de datos para la tabla `vtiger_quotestage`
--
...
--
-- Volcado de datos para la tabla `vtiger_quotestage_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_rating`
--
...
--
-- Volcado de datos para la tabla `vtiger_rating_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_recurringtype`
--
...
--
-- Volcado de datos para la tabla `vtiger_recurringtype_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_recurring_frequency`
--
...
--
-- Volcado de datos para la tabla `vtiger_recurring_frequency_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_relatedlists`
--
...
(90, 30, 13, 'get_related_list', 1, 'HelpDesk', 0, 'ADD,SELECT'),
(91, 30, 20, 'get_quotes', 2, 'Quotes', 0, 'ADD'),
(92, 30, 21, 'get_purchase_orders', 3, 'Purchase Order', 0, 'ADD'),
(93, 30, 22, 'get_salesorder', 4, 'Sales Order', 0, 'ADD'),
(94, 30, 23, 'get_invoices', 5, 'Invoice', 0, 'ADD'),
(95, 30, 19, 'get_service_pricebooks', 6, 'PriceBooks', 0, 'ADD'),
(96, 30, 7, 'get_related_list', 7, 'Leads', 0, 'SELECT'),
(97, 30, 6, 'get_related_list', 8, 'Accounts', 0, 'SELECT'),
(98, 30, 4, 'get_related_list', 9, 'Contacts', 0, 'SELECT'),
(99, 30, 2, 'get_related_list', 10, 'Potentials', 0, 'SELECT'),
(100, 30, 8, 'get_attachments', 11, 'Documents', 0, 'ADD,SELECT'),
(101, 13, 30, 'get_related_list', 5, 'Services', 0, 'SELECT'),
(102, 7, 30, 'get_related_list', 7, 'Services', 0, 'SELECT'),
...
(107, 33, 13, 'get_related_list', 1, 'Service Requests', 0, 'ADD,SELECT'),
(108, 33, 8, 'get_attachments', 2, 'Documents', 0, 'ADD,SELECT'),
(109, 6, 33, 'get_dependents_list', 15, 'Service Contracts', 0, 'ADD'),
(110, 4, 33, 'get_dependents_list', 14, 'Service Contracts', 0, 'ADD'),
(111, 13, 33, 'get_related_list', 6, 'Service Contracts', 0, 'ADD,SELECT'),
(112, 4, 36, 'get_dependents_list', 15, 'PBXManager', 0, ''),
(113, 7, 36, 'get_dependents_list', 8, 'PBXManager', 0, ''),
(114, 6, 36, 'get_dependents_list', 16, 'PBXManager', 0, ''),
...
--
-- Volcado de datos para la tabla `vtiger_relatedlists_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_relcriteria`
--
...
--
-- Estructura de tabla para la tabla `vtiger_relcriteria_grouping`
--
...
--
-- Volcado de datos para la tabla `vtiger_relcriteria_grouping`
--
...
--
-- Volcado de datos para la tabla `vtiger_reminder_interval`
--
...
--
-- Volcado de datos para la tabla `vtiger_reminder_interval_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_report`
--
...
--
-- Volcado de datos para la tabla `vtiger_reportdatefilter`
--
...
--
-- Volcado de datos para la tabla `vtiger_reportfilters`
--
...
--
-- Volcado de datos para la tabla `vtiger_reportfolder`
--
...
--
-- Estructura de tabla para la tabla `vtiger_reportgroupbycolumn`
--
...
--
-- Volcado de datos para la tabla `vtiger_reportmodules`
--
...
--
-- Volcado de datos para la tabla `vtiger_reportsortcol`
--
...
--
-- Estructura de tabla para la tabla `vtiger_reporttype`
--
...
--
-- Volcado de datos para la tabla `vtiger_role`
--
...
--
-- Volcado de datos para la tabla `vtiger_role2picklist`
--
...
--
-- Volcado de datos para la tabla `vtiger_role2profile`
--
...
--
-- Volcado de datos para la tabla `vtiger_role_seq`
--
...
--
-- Estructura de tabla para la tabla `vtiger_rowheight`
--
...
--
-- Volcado de datos para la tabla `vtiger_rowheight`
--
...
--
-- Estructura de tabla para la tabla `vtiger_rowheight_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_rowheight_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_sales_stage`
--
...
--
-- Volcado de datos para la tabla `vtiger_sales_stage_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_salutationtype`
--
...
--
-- Volcado de datos para la tabla `vtiger_salutationtype_seq`
--
...
--
-- Estructura de tabla para la tabla `vtiger_scheduled_reports`
--
...
--
-- Estructura de tabla para la tabla `vtiger_schedulereports`
--
...
--
-- Volcado de datos para la tabla `vtiger_seactivityrel_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_selectcolumn`
--
...
--
-- Volcado de datos para la tabla `vtiger_selectquery`
--
...
--
-- Volcado de datos para la tabla `vtiger_selectquery_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_servicecategory_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_servicecontracts`
--
...
(9, '2016-07-07', '2016-07-07', 3, '', '0.00', '0.00', 'Contrato', '2017-07-06', '365', '1', 'Complete', '', '', NULL, 'SERCON1');
...
CREATE TABLE IF NOT EXISTS `vtiger_servicecontractscf` (
  ...
  `cf_751` text,
  `cf_753` decimal(24,8) DEFAULT NULL,
  `cf_755` text,
  PRIMARY KEY (`servicecontractsid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Volcado de datos para la tabla `vtiger_servicecontractscf`
--

INSERT INTO `vtiger_servicecontractscf` (`servicecontractsid`, `cf_751`, `cf_753`, `cf_755`) VALUES
(9, 'Estudio Juiridico sobre la viabilidad, preservación riesgos y posibles variaciones de la garantía real de hipoteca sobre el bien inmueble descrito con folio ya mencionado, efectos de la garantia y  su recomendación tipo de garantía, naturaleza jurídica del contrato de  hipoteca, el contratista se debera pronunciar acerca de cada  uno de los terminos señalados en este numeral y su manifestación tendrá que ser escrita, y si es preciso ampliar la información de  forma verbal. Paragrafo: este contrato se ejecutara en un plazo maximo de 48 horas contados a partir de la entrega de los documentos solicitados al cliente en la clausula 10 del presente contrato y el anticipo confirmado en la cuenta mensionada en le  recibo', '340000.00000000', '1) anticipo de del  50% de la totalidad de los honorarios para iniciar el estudio, confirmado en cuenta a traves de cualquier medio lectrónico,2) el  restante a la entrega del estudio tecnico juridico objeto del presente contrato , o el solo desestimiento por cualquier causa del cliente  dara lugar al pago de los honorarios restantes');
...
--
-- Volcado de datos para la tabla `vtiger_service_usageunit`
--
...
--
-- Volcado de datos para la tabla `vtiger_service_usageunit_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_settings_blocks`
--
...
--
-- Volcado de datos para la tabla `vtiger_settings_blocks_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_settings_field`
--
...
--
-- Volcado de datos para la tabla `vtiger_settings_field_seq`
--
...
--
-- Estructura de tabla para la tabla `vtiger_shareduserinfo`
--
...
--
-- Volcado de datos para la tabla `vtiger_shippingtaxinfo`
--
...
--
-- Volcado de datos para la tabla `vtiger_shippingtaxinfo_seq`
--
...
--
-- Estructura de tabla para la tabla `vtiger_shorturls`
--
...
--
-- Estructura de tabla para la tabla `vtiger_smsnotifier`
--
...
--
-- Estructura de tabla para la tabla `vtiger_smsnotifiercf`
--
...
--
-- Estructura de tabla para la tabla `vtiger_smsnotifier_servers`
--
...
--
-- Estructura de tabla para la tabla `vtiger_smsnotifier_status`
--
...
--
-- Volcado de datos para la tabla `vtiger_sostatus`
--
...
--
-- Volcado de datos para la tabla `vtiger_sostatus_seq`
--
...
--
-- Estructura de tabla para la tabla `vtiger_sqltimelog`
--
...
--
-- Estructura de tabla para la tabla `vtiger_start_hour`
--
...
--
-- Volcado de datos para la tabla `vtiger_start_hour`
--
...
--
-- Estructura de tabla para la tabla `vtiger_start_hour_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_start_hour_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_status`
--
...
--
-- Volcado de datos para la tabla `vtiger_status_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_tab`
--
...
(30, 'Services', 0, -1, 'Services', NULL, NULL, 0, 0, 1, 0, '2.6', 'Inventory'),
(31, 'MailManager', 0, -1, 'MailManager', NULL, NULL, 1, 0, 0, 0, '1.9', 'Tools'),
(32, 'Import', 0, -1, 'Import', NULL, NULL, 1, 0, 0, 0, '1.7', ''),
(33, 'ServiceContracts', 0, -1, 'Service Contracts', NULL, NULL, 0, 0, 1, 0, '2.4', 'Support'),
(34, 'WSAPP', 0, -1, 'WSAPP', NULL, NULL, 1, 0, 0, 0, '3.4.4', ''),
(35, 'ModTracker', 0, -1, 'ModTracker', NULL, NULL, 0, 0, 0, 0, '1.2', ''),
(36, 'PBXManager', 0, -1, 'PBXManager', NULL, NULL, 1, 0, 1, 0, '2.2', 'Tools'),
(37, 'Mobile', 0, -1, 'Mobile', NULL, NULL, 1, 0, 0, 0, '2.0', ''),
...
(41, 'Webforms', 0, -1, 'Webforms', NULL, NULL, 0, 0, 0, 0, '1.6', ''),
(42, 'SMSNotifier', 0, -1, 'SMSNotifier', NULL, NULL, 0, 0, 1, 0, '1.9', 'Tools'),
(43, 'Google', 0, -1, 'Google', NULL, NULL, 0, 0, 0, 0, '1.5', ''),
(44, 'ProjectMilestone', 0, -1, 'ProjectMilestone', NULL, NULL, 0, 0, 1, 0, '3.0', 'Support'),
(45, 'ProjectTask', 0, -1, 'ProjectTask', NULL, NULL, 0, 0, 1, 0, '3.1', 'Support'),
(46, 'Project', 0, -1, 'Project', NULL, NULL, 0, 0, 1, 0, '3.3', 'Support'),
(47, 'RecycleBin', 0, -1, 'Recycle Bin', NULL, NULL, 0, 0, 0, 0, '1.5', 'Tools'),
(48, 'ModComments', 0, -1, 'Comments', NULL, NULL, 0, 0, 1, 0, '2.1', 'Tools'),
(49, 'ExtensionStore', 0, -1, 'Extension Store', NULL, NULL, 1, 0, 0, 0, '1.2', 'Settings');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `vtiger_tab_info`
--
...
--
-- Volcado de datos para la tabla `vtiger_tab_info`
--
...
--
-- Volcado de datos para la tabla `vtiger_taskpriority`
--
...
--
-- Volcado de datos para la tabla `vtiger_taskpriority_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_taskstatus`
--
...
--
-- Volcado de datos para la tabla `vtiger_taskstatus_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_taxclass`
--
...
--
-- Volcado de datos para la tabla `vtiger_taxclass_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_ticketcategories`
--
...
--
-- Volcado de datos para la tabla `vtiger_ticketcategories_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_ticketpriorities`
--
...
--
-- Volcado de datos para la tabla `vtiger_ticketpriorities_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_ticketseverities`
--
...
--
-- Volcado de datos para la tabla `vtiger_ticketseverities_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_ticketstatus`
--
...
--
-- Volcado de datos para la tabla `vtiger_ticketstatus_seq`
--
...
--
-- Estructura de tabla para la tabla `vtiger_time_zone`
--
...
--
-- Volcado de datos para la tabla `vtiger_time_zone`
--
...
--
-- Estructura de tabla para la tabla `vtiger_time_zone_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_time_zone_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_tracking_unit`
--
...
--
-- Volcado de datos para la tabla `vtiger_tracking_unit_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_usageunit`
--
...
--
-- Volcado de datos para la tabla `vtiger_usageunit_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_user2role`
--
...
(1, 'admin', '$1$ad000000$KaLAybsZQArVaSQtnq4F3/', 'd41d8cd98f00b204e9800998ecf8427e', '#E6FAD8', 'Alfredo', 'Bravo Cuero', '', 'on', 1, '', '2016-06-22 15:14:44', '0000-00-00 00:00:00', NULL, '', '', '', '', '', '', '', 'yo@alfredobravocuero.co', '', '', 'Active', '', '', '', '', '', '', NULL, NULL, NULL, NULL, NULL, NULL, 'mm-dd-yyyy', '12', '00:00', '23:00', 'This Week', 'Today', '', 0, '$1$ad000000$nYTnfhTZRmUP.wQT9y1AE.', '1', '1 Minute', NULL, 'PHP5.3MD5', '4Z2QfKdkPtGiW9T', 'alphagrey', 'es_es', 'America/Bogota', '123,456,789', '.', ',', '$1.0', '', '2', '1', 'Sunday', '5', '5', 'public', 'Summary', '0', 'medium', NULL, NULL, 0, '1');
...
--
-- Volcado de datos para la tabla `vtiger_users2group`
--
...
--
-- Estructura de tabla para la tabla `vtiger_userscf`
--
...
--
-- Volcado de datos para la tabla `vtiger_users_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_version`
--
...
--
-- Volcado de datos para la tabla `vtiger_version_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_visibility`
--
...
--
-- Volcado de datos para la tabla `vtiger_visibility_seq`
--
...
--
-- Estructura de tabla para la tabla `vtiger_webforms`
--
...
--
-- Estructura de tabla para la tabla `vtiger_wsapp`
--
...
--
-- Volcado de datos para la tabla `vtiger_wsapp`
--

INSERT INTO `vtiger_wsapp` (`appid`, `name`, `appkey`, `type`) VALUES
(1, 'vtigerCRM', '576aa836ee785', 'user');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `vtiger_wsapp_handlerdetails`
--
...
--
-- Volcado de datos para la tabla `vtiger_wsapp_handlerdetails`
--
...
--
-- Estructura de tabla para la tabla `vtiger_wsapp_queuerecords`
--
...
--
-- Estructura de tabla para la tabla `vtiger_wsapp_recordmapping`
--
...
--
-- Estructura de tabla para la tabla `vtiger_wsapp_sync_state`
--
...
--
-- Volcado de datos para la tabla `vtiger_ws_entity`
--
...
--
-- Volcado de datos para la tabla `vtiger_ws_entity_fieldtype`
--
...
--
-- Volcado de datos para la tabla `vtiger_ws_entity_fieldtype_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_ws_entity_name`
--
...
--
-- Volcado de datos para la tabla `vtiger_ws_entity_referencetype`
--
...
--
-- Volcado de datos para la tabla `vtiger_ws_entity_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_ws_entity_tables`
--
...
--
-- Estructura de tabla para la tabla `vtiger_ws_fieldinfo`
--
...
--
-- Volcado de datos para la tabla `vtiger_ws_fieldinfo`
--
...
--
-- Volcado de datos para la tabla `vtiger_ws_fieldtype`
--
...
--
-- Volcado de datos para la tabla `vtiger_ws_operation`
--
...
--
-- Volcado de datos para la tabla `vtiger_ws_operation_parameters`
--
...
--
-- Volcado de datos para la tabla `vtiger_ws_operation_seq`
--
...
--
-- Volcado de datos para la tabla `vtiger_ws_referencetype`
--
...
--
-- Filtros para la tabla `vtiger_assets`
--
...
--
-- Filtros para la tabla `vtiger_pbxmanager_phonelookup`
--
